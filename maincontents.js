...
function FC_ContentsCall(strContentsName, strLanguage)
{
	...
	if(strContentsName == "InterpretingSummaries")   
	{
		
		if(strLanguage=="En") { PlaySpeech("InterpretingSummaries");  }
		
		location.href = "Contents/InterpretingSummaries/InterpretingSummaries.htm";
	}
	if(strContentsName == "BadgeScanning")   
	{	
		location.href = "Contents/BadgeScanning/BadgeScanning.htm";
	}
	if(strContentsName == "InformationRequest")   
	{
		
		location.href = "Contents/InformationRequest/InformationRequest.htm";
	}
...
if(strContentsName == "Quiz")   
	...
	if(strContentsName == "Sarcomere")   
	{
		
		if(strLanguage=="En") { PlaySpeech("I will introduce the Future Robot.");  }
		
		location.href = "Contents/Sarcomere/Sarcomere.htm";
	}
	
	if(strContentsName == "Cardiovascular")   
	{
		...
		location.href = "Contents/CardiovascularRisk/Cardiovascular.htm";
	}
